...
const Carousel = () => {
  ...
  const slides = [
    ...
    {
      image: "https://res.cloudinary.com/dl7rnltwv/image/upload/v1744686361/IMG_4124_jcwkvc.jpg",
      title: "Habitaciones de Ensueño",
      description: "Descanse en nuestras cómodas y elegantes habitaciones"
    },
    {
      image: "https://res.cloudinary.com/dl7rnltwv/image/upload/v1744686379/IMG_4177_cuphoc.jpg",
